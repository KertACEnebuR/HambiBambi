...
ALTER TABLE `Baskets` ADD FOREIGN KEY (`payment_id`) REFERENCES `Payments` (`payment_id`);

ALTER TABLE `Baskets` ADD FOREIGN KEY (`order_status_id`) REFERENCES `Order_Statuses` (`order_status_id`);
